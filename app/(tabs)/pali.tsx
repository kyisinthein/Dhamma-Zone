...
export default function PaliPage() {
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedText type="title" style={styles.title}>ပါဠိ</ThemedText>
              ...
              <View style={styles.cardRight}>
                ...
                {item.text_link ? (
                  <TouchableOpacity style={styles.readBtnWide} onPress={() => WebBrowser.openBrowserAsync(item.text_link!)}>
                    <ThemedText style={styles.readBtnText}>Read More</ThemedText>
                  </TouchableOpacity>
                ) : null}
              </View>
            </View>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#55372B' },
  title: { alignSelf: 'center', marginVertical: 12, color: '#fff' },
  ...
  cardRight: { width: 140, alignItems: 'center', gap: 8, borderLeftWidth: 2, borderLeftColor: '#e9d3c6' },
  cardTitle: { fontSize: 20, color: '#55372B' },
  cardText: { fontSize: 15, color: '#55372B' },
  cardThumbWrap: { width: 120, height: 120, backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden' },
  cardThumb: { width: '100%', height: '100%' },
  readBtnWide: { backgroundColor: '#c54e36', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12 },
  readBtnText: { color: '#fff' },
  footer: {
    position: 'absolute',
    left: 40,
    right: 40,
